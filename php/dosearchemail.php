...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(!empty($_POST["email"])){
      ...
      if($error != null){
        ...
        $sql = "SELECT userID, username,firstName,lastName,email,bio FROM users WHERE email like '%" . $email . "%';";
        ...
        if($result -> num_rows > 0){
          ...
          echo "<a href=\"searchemail.php\">search another user by email</a>";
        }else{
          echo "user does not exist";
          echo "<br>";
          echo "<a href=\"searchemail.php\">try to search again</a>";
        }
